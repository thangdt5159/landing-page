...
import featureCollectionsData from "../../data/featureCollectionsData";

const FeatureCollectionCarousel = () => {
  return (
    <>
      <Swiper
      ...
      >
        {featureCollectionsData.map((item) => {
          const {
            id,
            bigImage,
            subImage1,
...
export default FeatureCollectionCarousel;
